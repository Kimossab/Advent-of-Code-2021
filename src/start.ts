...
import { day17Part1, day17Part2 } from "./17";
import { day18Part1, day18Part2 } from "./18";
import { day19Part1, day19Part2 } from "./19";
...
start = +new Date();
const d17p1 = day17Part1();
end = +new Date();
console.log(`[${prettyMilliseconds(end - start)}][2021][Day 17][Part 1]: ${d17p1}`);
start = +new Date();
const d17p2 = day17Part2();
end = +new Date();
console.log(`[${prettyMilliseconds(end - start)}][2021][Day 17][Part 2]: ${d17p2}`);

start = +new Date();
const d18p1 = day18Part1();
end = +new Date();
console.log(`[${prettyMilliseconds(end - start)}][2021][Day 18][Part 1]: ${d18p1}`);
start = +new Date();
const d18p2 = day18Part2();
end = +new Date();
console.log(`[${prettyMilliseconds(end - start)}][2021][Day 18][Part 2]: ${d18p2}`);

start = +new Date();
const d19p1 = day19Part1();
end = +new Date();
console.log(`[${prettyMilliseconds(end - start)}][2021][Day 19][Part 1]: ${d19p1}`);
start = +new Date();
const d19p2 = day19Part2();
end = +new Date();
console.log(`[${prettyMilliseconds(end - start)}][2021][Day 19][Part 2]: ${d19p2}`);

start = +new Date();
const d20p1 = day20Part1();
end = +new Date();
console.log(`[${prettyMilliseconds(end - start)}][2021][Day 20][Part 1]: ${d20p1}`);
start = +new Date();
const d20p2 = day20Part2();
end = +new Date();
console.log(`[${prettyMilliseconds(end - start)}][2021][Day 20][Part 2]: ${d20p2}`);

start = +new Date();
const d21p1 = day21Part1();
end = +new Date();
console.log(`[${prettyMilliseconds(end - start)}][2021][Day 21][Part 1]: ${d21p1}`);
start = +new Date();
const d21p2 = day21Part2();
end = +new Date();
console.log(`[${prettyMilliseconds(end - start)}][2021][Day 21][Part 2]: ${d21p2}`);

start = +new Date();
const d22p1 = day22Part1();
end = +new Date();
console.log(`[${prettyMilliseconds(end - start)}][2021][Day 22][Part 1]: ${d22p1}`);
start = +new Date();
const d22p2 = day22Part2();
end = +new Date();
